<div>
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="{{asset('frontend/business-3d-online-payment.png')}}" />
        </div>
      </div>
    </div>
    ...
    <section class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        Here is our wonderful features that we want to highlight for you, so you can understand out app more better.              <br />
              <br />
            </p>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            Wonderful & Effortless way to control your finances right            </h3>
            <p class="text-gray-600 mb-8">
            The next generation time-tracking that not only records your financial past, but also helps you plan and predict a profitable future.
              <br />
              <br />
            </p>
          </div>
          <div class="w-full sm:w-1/2 p-6">
                    <img src="{{asset('frontend/undraw_wallet_aym5.svg')}}" alt="" width="400">
                </div>
        </div>
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
        <div class="w-full sm:w-1/2 p-6">
                    <img src="{{asset('frontend/undraw_credit_card_payment_re_o911.svg')}}" alt="" width="400">
                </div>
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
              Introducing the limiter as the name you can expect it's just a limiter for your expenses.
                <br />
                <br />
              </p>
            </div>
