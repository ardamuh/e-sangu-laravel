    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="{{url('/')}}">
            ...
            <img class="h-9 fill-current inline" src="{{asset('frontend/ic_app_circular.png')}}" />
            E-sangu
          </a>
        </div>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20"
          ...
          @auth
                    <a href="{{url('/budgeting')}}" id="navAction"
                ...
                @endauth
                @guest
                    <a href="{{url('/register')}}" class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" >
                        Register</a>
                    &nbsp;
